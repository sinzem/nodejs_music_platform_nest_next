...
export type NextThunkDispatch = ThunkDispatch<RootState, void, AnyAction> /* (создаем тип для диспетчера(по документации), понадобится при запросах(pages/tracks/index.js)) */